...
class Resnet_gau_add(nn.Module):
    
    def __init__(self, resnet='resnet34'):
        super(Resnet_gau_add, self).__init__()
        ...
        fc_features = backbone.fc.in_features
        # self.fc1 = torch.nn.Linear(fc_features * 2, fc_features)
        self.fc = torch.nn.Linear(fc_features, 3)
    ...
    def forward(self, img):
        ...
        return self.fc(rgb_feat + gau_feat)