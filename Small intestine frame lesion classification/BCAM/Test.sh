...
CUDA_VISIBLE_DEVICES=2 python main.py --dataset_name Crohn15to23 \
               ...
               --pretrained False \
               --wsol_method "bcam" \
               --experiment_name resnet34_bas_acol_epo16 \
               ...
               --check_path "/mnt/minio/node77/caiyinqi/BCAM-main/SingleObjectLocalization/train_log_prob/resnet34_bas_acol/16_checkpoint.pth.tar" \
               --mode "test" \
               --seed 4 \
               --target_layer "layer4" \
               --eval_type $eval_type \
